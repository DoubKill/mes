...
class EquipWarehouseOrderFilter(django_filters.rest_framework.FilterSet):
    ...
    spare_code = django_filters.CharFilter(field_name='order_detail__equip_spare__spare_code', lookup_expr='icontains')
    spare_name = django_filters.CharFilter(field_name='order_detail__equip_spare__spare_name', lookup_expr='icontains')
...
class EquipWarehouseOrderDetailFilter(django_filters.rest_framework.FilterSet):
    order_id = django_filters.CharFilter(field_name='equip_warehouse_order__order_id', lookup_expr='icontains')
    s_time = django_filters.CharFilter(field_name='created_date__date', lookup_expr='gte')
    e_time = django_filters.CharFilter(field_name='created_date__date', lookup_expr='lte')
    created_user = django_filters.CharFilter(field_name='created_user__username', lookup_expr='icontains')
...
class EquipWarehouseRecordFilter(django_filters.rest_framework.FilterSet):
    ...
    order_id = django_filters.CharFilter(field_name='equip_warehouse_order_detail__equip_warehouse_order__order_id', lookup_expr='icontains')
    created_user = django_filters.CharFilter(field_name='created_user__username', lookup_expr='icontains')
    ...
    real_time = django_filters.CharFilter(field_name='real_time__date')
    warehouse_area = django_filters.CharFilter(field_name='equip_warehouse_area__area_name', lookup_expr='icontains')
    warehouse_location = django_filters.CharFilter(field_name='equip_warehouse_location__location_name', lookup_expr='icontains')

    class Meta:
        model = EquipWarehouseRecord
        fields = (
            'equip_warehouse_order_detail', 's_time', 'e_time', 'status', 'spare_name', 'spare_code', 'real_time',
            'specification', 'equip_component_type', 'order_id', 'created_user', 'revocation', 'receive_user', 'purpose',
            'warehouse_area', 'warehouse_location')
...
class EquipWarehouseInventoryFilter(django_filters.rest_framework.FilterSet):
    ...
    class Meta:
        ...
        fields = ('spare_name', 'spare_code', 'specification', 'equip_spare', 'warehouse_area', 'warehouse_location', 'equip_component_type')
...
class CheckPointTableFilter(django_filters.rest_framework.FilterSet):
    select_date = django_filters.DateFromToRangeFilter(field_name='select_date', help_text='检查日期',
                                                       lookup_expr='range')
...
class CheckTemperatureTableFilter(django_filters.rest_framework.FilterSet):
    select_date = django_filters.DateFromToRangeFilter(field_name='select_date', help_text='检查日期', lookup_expr='range')
