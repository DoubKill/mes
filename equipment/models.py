...
class EquipResultDetail(AbstractEntity):
    ...
    job_item_check_standard = models.CharField(max_length=64, help_text='判断标准及说明', null=True, blank=True)
    job_item_check_type = models.CharField(max_length=64, help_text='判断类型', null=True, blank=True)
    operation_result = models.CharField(max_length=64, help_text='处理结果', null=True, blank=True)
