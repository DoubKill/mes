...
class EquipApplyOrder(AbstractEntity):
    ...
    status = models.CharField(max_length=64, help_text='状态:已生成、已指派、已接单、已开始、已完成、已验收', null=True, blank=True)
...
class CheckPointTable(AbstractEntity):
    ...
    finish_flag = models.BooleanField(help_text='是否为提交状态', default=False)
...
class DingUser(models.Model):
    ...
    phone_number = models.CharField(max_length=64, help_text='手机号', default='')
    ding_uid = models.CharField(max_length=64, help_text='钉钉用户id', default='')
