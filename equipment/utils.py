...
class DinDinAPI(object):
    ...
    def get_user_id(self, phone_num):
        ...
        ret = requests.post(url, params={'access_token': self.access_token}, data={"mobile": phone_num}, timeout=10)
        data = json.loads(ret.text)
    ...
    def send_message(self, user_ids, content, order_id=0, inspection=False):
        ...
        ret = requests.post(url, params={'access_token': self.access_token}, json=data, timeout=10)
        data = json.loads(ret.text)
