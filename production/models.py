...
class RubberWrongMaskReason(models.Model):
    reason_name = models.CharField(help_text='原因名称', max_length=64)
    factory_date = models.DateTimeField(help_text='工厂时间')
    machine_no = models.CharField(max_length=64, help_text='机台')
    production_no = models.CharField(max_length=64, help_text='配方名')
    ...
    class Meta:
        db_table = 'rubber_wrong_mask_reason'
...
class MachineTargetYieldSettings(models.Model):
    ...
    Z01_max = models.IntegerField(help_text='机台最高值', default=0)
    Z02_max = models.IntegerField(help_text='机台最高值', default=0)
    Z03_max = models.IntegerField(help_text='机台最高值', default=0)
    Z04_max = models.IntegerField(help_text='机台最高值', default=0)
    Z05_max = models.IntegerField(help_text='机台最高值', default=0)
    Z06_max = models.IntegerField(help_text='机台最高值', default=0)
    Z07_max = models.IntegerField(help_text='机台最高值', default=0)
    Z08_max = models.IntegerField(help_text='机台最高值', default=0)
    Z09_max = models.IntegerField(help_text='机台最高值', default=0)
    Z10_max = models.IntegerField(help_text='机台最高值', default=0)
    Z11_max = models.IntegerField(help_text='机台最高值', default=0)
    Z12_max = models.IntegerField(help_text='机台最高值', default=0)
    Z13_max = models.IntegerField(help_text='机台最高值', default=0)
    Z14_max = models.IntegerField(help_text='机台最高值', default=0)
...
class FillCardApply(models.Model):
    ...
    desc = models.CharField(max_length=512, help_text='补卡理由', null=True, blank=True)
    handling_suggestion = models.CharField(max_length=512, help_text='处理意见', null=True, blank=True)
    handling_result = models.NullBooleanField(help_text='处理结果', default=None)
    approver = models.CharField(max_length=16, help_text='三级审批人', null=True, blank=True)
    approver_time = models.DateTimeField(null=True, blank=True)
    ...
    f_approver = models.CharField(max_length=16, help_text='一级审批人', null=True, blank=True)
    f_handling_suggestion = models.CharField(max_length=512, help_text='处理意见', null=True, blank=True)
    f_handling_result = models.NullBooleanField(help_text='处理结果', default=None)
    f_approver_time = models.DateTimeField(null=True, blank=True)
    s_approver = models.CharField(max_length=16, help_text='二级审批人', null=True, blank=True)
    s_handling_suggestion = models.CharField(max_length=512, help_text='处理意见', null=True, blank=True)
    s_handling_result = models.NullBooleanField(help_text='处理结果', default=None)
    s_approver_time = models.DateTimeField(null=True, blank=True)
...
class ApplyForExtraWork(models.Model):
    ...
    desc = models.CharField(max_length=512, help_text='加班理由', null=True, blank=True)
    handling_suggestion = models.CharField(max_length=512, help_text='处理意见', null=True, blank=True)
    apply_date = models.DateTimeField(auto_now_add=True, help_text='申请时间')
    handling_result = models.NullBooleanField(help_text='处理结果', default=None)
    approver_time = models.DateTimeField(null=True, blank=True)
...
class ToolManageAccount(models.Model):
    save_date = models.DateTimeField(auto_now_add=True)
    save_user = models.CharField(max_length=64, help_text='保存人', null=True, blank=True)
    year = models.CharField(max_length=64, help_text='年份', null=True, blank=True)
    day = models.TextField(help_text='工装管理台帐日期表头', null=True, blank=True)
    content = models.TextField(help_text='工装管理台帐内容', null=True, blank=True)
...
class FinishRatio(models.Model):
    ...
    username = models.CharField(max_length=64, help_text='人员')
