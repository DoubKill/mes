...
class SpareInventoryLogFilter(django_filters.rest_framework.FilterSet):
    ...
    location_no = django_filters.CharFilter(field_name='location', help_text='库存位', lookup_expr='icontains')
    ...
    class Meta:
        ...
        fields = ('spare_no', 'spare_name', 'location_no', 'begin_time', 'end_time', 'type', 'type_name')
