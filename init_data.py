...
permission_data = [
    ...
    {'id': 928, 'code': 'performance_summary', 'name': '员工绩效汇总表', 'parent_id': None},
    ...
    {'id': 938, 'code': 'performance_unit_price', 'name': '绩效计算单价表', 'parent_id': None},
    ...
    {'id': 942, 'code': 'employee_attendance_records', 'name': '员工出勤记录表', 'parent_id': None},
    ...
    {'id': 949, 'code': 'summary_of_weighing_output', 'name': '称量机台产量汇总表', 'parent_id': None},
    ...
    {'id': 1050, 'code': 'excel_check_point_standard', 'name': '导入/导出', 'parent_id': 1046},

    {'id': 1051, 'code': 'check_point_table', 'name': '岗位安全装置点检表', 'parent_id': None},
    {'id': 1052, 'code': 'view_check_point_table', 'name': '查看', 'parent_id': 1051},
    {'id': 1053, 'code': 'add_check_point_table', 'name': '新增', 'parent_id': 1051},
    {'id': 1054, 'code': 'change_check_point_table', 'name': '编辑', 'parent_id': 1051},
    {'id': 1055, 'code': 'confirm_check_point_table', 'name': '确认', 'parent_id': 1051},
    {'id': 1056, 'code': 'delete_check_point_table', 'name': '删除', 'parent_id': 1051},
    {'id': 1057, 'code': 'export_check_point_table', 'name': '导出', 'parent_id': 1051},

    {'id': 1058, 'code': 'check_temperature_standard', 'name': '除尘袋滤器温度标准', 'parent_id': None},
    {'id': 1059, 'code': 'view_check_temperature_standard', 'name': '查看', 'parent_id': 1058},
    {'id': 1060, 'code': 'add_check_temperature_standard', 'name': '新增', 'parent_id': 1058},
    {'id': 1061, 'code': 'change_check_temperature_standard', 'name': '编辑', 'parent_id': 1058},
    {'id': 1062, 'code': 'delete_check_temperature_standard', 'name': '删除', 'parent_id': 1058},
    {'id': 1063, 'code': 'excel_check_temperature_standard', 'name': '导出/导入', 'parent_id': 1058},

    {'id': 1064, 'code': 'check_temperature_table', 'name': '除尘袋滤器温度检查表', 'parent_id': None},
    {'id': 1065, 'code': 'view_check_temperature_table', 'name': '查看', 'parent_id': 1064},
    {'id': 1066, 'code': 'add_check_temperature_table', 'name': '新增', 'parent_id': 1064},
    {'id': 1067, 'code': 'change_check_temperature_table', 'name': '编辑', 'parent_id': 1064},
    {'id': 1068, 'code': 'delete_check_temperature_table', 'name': '删除', 'parent_id': 1064},
    {'id': 1069, 'code': 'confirm_check_temperature_table', 'name': '批量确认', 'parent_id': 1064},
    {'id': 1070, 'code': 'export_check_temperature_table', 'name': '导出', 'parent_id': 1064},
