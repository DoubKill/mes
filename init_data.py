...
permission_data = [
    ...
    {'id': 324, 'code': 'equip_status', 'name': '设备运行现况', 'parent_id': None},
    {'id': 325, 'code': 'view_equip_status', 'name': '查看', 'parent_id': 324},

    {'id': 326, 'code': 'equip_maintenance_order_log', 'name': '设备维修履历', 'parent_id': None},
    {'id': 327, 'code': 'view_equip_maintenance_order_log', 'name': '查看', 'parent_id': 326},

    {'id': 328, 'code': 'property_type_node', 'name': '资产类型节点', 'parent_id': None},
    {'id': 329, 'code': 'view_property_type_node', 'name': '查看', 'parent_id': 328},
    {'id': 330, 'code': 'add_property_type_node', 'name': '增加', 'parent_id': 328},
    {'id': 331, 'code': 'delete_property_type_node', 'name': '删除', 'parent_id': 328},

    {'id': 332, 'code': 'property', 'name': '资产', 'parent_id': None},
    {'id': 333, 'code': 'view_property', 'name': '查看', 'parent_id': 332},
    {'id': 334, 'code': 'add_property', 'name': '增加', 'parent_id': 332},
    {'id': 335, 'code': 'change_property', 'name': '编辑', 'parent_id': 332},
    {'id': 336, 'code': 'delete_property', 'name': '删除', 'parent_id': 332},
    {'id': 337, 'code': 'import_property', 'name': '导入', 'parent_id': 332},
    {'id': 338, 'code': 'download_property', 'name': '模板下载', 'parent_id': 332},

    {'id': 339, 'code': 'platform_config', 'name': '通知配置', 'parent_id': None},
    {'id': 340, 'code': 'add_platform_config', 'name': '增加', 'parent_id': 339},
    {'id': 341, 'code': 'delete_platform_config', 'name': '删除', 'parent_id': 339},
    {'id': 342, 'code': 'change_platform_config', 'name': '编辑', 'parent_id': 339},
    {'id': 343, 'code': 'view_platform_config', 'name': '查看', 'parent_id': 339},
