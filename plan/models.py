...
class SchedulingRecipeMachineSetting(AbstractEntity):
    ...
    main_machine_HMB = models.CharField(max_length=128, help_text='HMB主机台', default='', blank=True)
    vice_machine_HMB = models.CharField(max_length=128, help_text='HMB辅机台', default='', blank=True)
    main_machine_CMB = models.CharField(max_length=128, help_text='CMB主机台', default='', blank=True)
    vice_machine_CMB = models.CharField(max_length=128, help_text='CMB辅机台', default='', blank=True)
    main_machine_1MB = models.CharField(max_length=128, help_text='1MB主机台', default='', blank=True)
    vice_machine_1MB = models.CharField(max_length=128, help_text='1MB辅机台', default='', blank=True)
    main_machine_2MB = models.CharField(max_length=128, help_text='2MB主机台', default='', blank=True)
